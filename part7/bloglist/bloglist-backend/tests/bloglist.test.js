...
describe("total likes", () => {
  ...
  test("when list has many blogs, equals the sum of the likes", () => {
...
describe("favorite blog", () => {
  ...
  test("when list has many blogs, it is the one with most likes", () => {
    const most =  {
      _id: "5a422b3a1b54a676234d17f9",
      title: "Canonical string reduction",
      author: "Edsger W. Dijkstra",
...
describe("most blogs", () => {
  ...
  test("when list has many blogs, it is the author with most blogs", () => {
...
describe("most likes", () => {
  ...
  test("when list has many blogs, it is the author with most likes", () => {
